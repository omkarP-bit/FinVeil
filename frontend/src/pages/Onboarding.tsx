...
export default function Onboarding() {
  const handleGoogleLogin = () => {
    // Stub: redirect to Google OAuth
    console.log('Google OAuth')
  }

  const handleAppleLogin = () => {
    // Stub: redirect to Apple OAuth
    ...
    <div className="flex flex-col items-center justify-center min-h-svh px-4">
      ...
      <div className="flex flex-col gap-3 w-full max-w-sm">
        <button
          ...
          className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-xl border border-border bg-white font-medium text-sm text-text hover:bg-surface-alt transition-colors cursor-pointer"
        >
